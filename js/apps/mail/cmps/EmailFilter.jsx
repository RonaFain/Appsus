export class EmailFilter extends React.Component {
    ...
    handleChange = ({ target }) => {
        ...
        this.setState((prevState) => ({ filterBy: { ...prevState.filterBy, [field]: mapValue[value]}}), () => {
    ...
    render() {
        ...
        <section className="email-filter-sort">
            ...
            <button className="sort-date-btn" onClick={this.props.onSetSort} name={'byDate'}>Sort by date</button>
            <button className="sort-subject-btn" onClick={this.props.onSetSort} name={'bySubject'}>Sort by subject</button>
        </section>)
    }
}